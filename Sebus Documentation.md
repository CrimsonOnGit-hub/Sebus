...
Now that you are in there, type this line:

Create box()

Create- Creates whatever. box- Defines that you are making a box. ()- Defines what the compiler/system calls the box.

Whatever you type in those brackets are very important. I'll go with box(Test)

Next- type Pos(). You see? Now you type what you put in the brackets in the first command so Sebus Compiler knows that the box is its own thing.
